const config = {
  appName: "Scheddly",
  appDescription:
    "Scheddly is a social media scheduling tool for e-commerce businesses and creators. Schedule posts across all platforms, track performance, and grow your audience with our comprehensive social media management platform.",
  appKeywords:
