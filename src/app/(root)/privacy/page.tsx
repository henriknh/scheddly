        ...
        <Card>
          ...
          <CardContent>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-1">
              <li>
                Provide, maintain, and improve our social media scheduling
                service
              </li>
              <li>
                Process and schedule your posts to connected social media
                platforms
              </li>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-1">
              ...
              <li>
                To social media platforms when you authorize us to post on your
                behalf
              </li>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground">
              ...
              Each platform has its own privacy policy, and we encourage you to
              review their policies. We are not responsible for the privacy
